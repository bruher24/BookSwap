    ...
    <div class="modal-dialog">
        <div class="modal-content rounded-4 shadow">
            <div class="modal-header p-5 pb-4 border-bottom-0">
                <h1 id="modalBookTitle" class="fw-bold mb-0 fs-2">Добавить книгу</h1>
            ...
            <div class="modal-body p-5 pt-0">
                <form id="bookForm" method="post" action="{{ route('books.store') }}">
                    ...
                    <div class="form-floating mb-3">
                        <select type="text" class="mainInput form-control form-select rounded-3" name="book_type"
                                id="floatingBookType">
                            <option selected value="0">Выберите тип...</option>
                        </select>
                        <label for="floatingBookType">Тип</label>
                    </div>
