<div class="row mt-3">
    @foreach($books as $book)
        <div class="book-card col-auto rounded-1 border shadow mb-5 me-2 p-0 d-flex flex-column" style="width: 200px; height: 320px; cursor: pointer;"
        data-book="{{ $book->id }}">
            <img alt="Упс! Произошла ошибка." src="MAIN_IMG_LINK" onerror="this.onerror=null; this.src='SPARE_IMG_LINK'" class="img-fluid rounded-top"
