...
final class TradeOfferApiTest extends TestCase
{
    ...
    public function test_user_can_create_trade_offer_as_sender(): void
    {
        ...
        $response->assertJsonPath('data.attributes.status', TradeOfferStatusEnum::Pending->value);
    ...
    public function test_user_cannot_delete_trade_offer(): void
    {
        Sanctum::actingAs($this->sender);
    ...
    public function test_admin_can_delete_trade_offer(): void
    {
        Sanctum::actingAs($this->admin);
